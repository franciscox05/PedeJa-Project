export const ADMIN_DASHBOARD_TABS = [
  ...
  { id: "avaliacoes", label: "Avaliacoes", description: "Avaliacoes de clientes a pedidos/restaurantes", icon: "avaliacoes", section: "Restaurantes", route: "/dashboard/admin/avaliacoes" },
  ...
  { id: "recrutamento", label: "Recrutamento", description: "Tarefas de seguimento de candidaturas e parcerias", icon: "recrutamento", section: "Pessoas", route: "/dashboard/admin/recrutamento" },
