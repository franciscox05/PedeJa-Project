-- Torna a foto de prova de entrega opcional (deixa de bloquear "Confirmar
-- entrega" sem foto) -- decisao do utilizador apos testar o fluxo. A coluna
-- prova_entrega_foto_url continua a guardar a foto quando o estafeta a
-- envia, so deixa de ser exigida.
